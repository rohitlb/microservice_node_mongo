...
<html lang="en">
<head>
    <title>Code coverage report for src/AwsMetadata.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> AwsMetadata.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(config = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
    ...
    async.parallel({
      ...
      accountId: callback =&gt; {
        ...
        this.lookupInstanceIdentity((error, identity) =&gt; {
          callback(null, i</span>dentity ? identity.accountId : <span class="branch-1 cbranch-no" title="branch not covered" >null);
        });
      },
    }, (error, results) =&gt; {
  ...
  lookupMetadataKey(key, callback) {
    request.get({
      ...
      if (<span class="missing-if-branch" title="if path not taken" >I</span>error) {
        this.<span class="cstat-no" title="statement not covered" >logger.error('Error requesting metadata key', error);</span>
      }
      callback(null, (</span>error || response.statusCode !== 200) ? <span class="branch-0 cbranch-no" title="branch not covered" >null : body);
    });
  }
&nbsp;
  lookupInstanceIdentity(callback) {
    request.get({
      ...
      if (<span class="missing-if-branch" title="if path not taken" >I</span>error) {
        this.<span class="cstat-no" title="statement not covered" >logger.error('Error requesting instance identity document', error);</span>
      }
      callback(null, (</span>error || response.statusCode !== 200) ? <span class="branch-0 cbranch-no" title="branch not covered" >null : JSON.parse(body));
    });
  }
}
&nbsp;</pre></td></tr>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Feb 01 2016 09:40:39 GMT-0800 (PST)
</div>
</div>
